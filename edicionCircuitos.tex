...
Realizamos ahora una extracción del circuito representado por el \emph{layout} y crear un \emph{netlist} SPICE, que incluya los elementos parásitos representados por los contactos, vías y metales utilizados para realizar las interconexiones.
