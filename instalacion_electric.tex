...
\begin{frame}[fragile]
\subsection{OpenJDK Java 6 } % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
